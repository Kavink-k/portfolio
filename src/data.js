...
export const projects = [
  ...
  },
  {
    ...
    thumbnail: "/assets/images/project2-thumbnail.jpg",
    screenshots: ["/assets/images/project2-screenshot1.jpg"],
    description: `A modern and intuitive task management application developed using React. It allows users to add, delete, and mark tasks as complete, with local storage persistence to remember tasks across sessions. Focus was placed on a clean UI/UX and efficient state management.`,
    technologies: ["React", "React Hooks", "CSS3", "Local Storage"],
    githubLink: "https://github.com/janedoe/task-manager-app",
  ...
  },
  {
    ...
    thumbnail: "/assets/images/project3-thumbnail.jpg",
    screenshots: ["/assets/images/project3-screenshot1.jpg"],
    description: `A basic blog platform backend built with Node.js and Express.js, exposing RESTful API endpoints for managing posts, comments, and users. Data is stored in a PostgreSQL database. Frontend is a simple HTML/CSS interface for demonstration purposes.`,
